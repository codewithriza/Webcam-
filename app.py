...
Email: codewithriza@gmail.com
        ...
        st.write("Click on start to use webcam and detect your face emotion , It's loading it will take a while, hang tight!")
        st.write("If it is isnt loading please try using mobile data or using personal hospot and make sure u allowed all the options or then try to change the browser ")
